...
Thank you for purchasing MediaShield CLI! This suite automatically protects your media assets using SHA-256 hashing and embeds copyright metadata directly into your files.
...
Give execution permissions to the scripts and run the installer:

  chmod +x install.sh media_shield_process.sh media_shield_watch.sh
  ./install.sh


### 3. Configure & Run

1. Open `config.env` and insert your license key and setup configuration.
2. Start watching your media directory:

  ./media_shield_watch.sh
...
• Linux / macOS : Fully supported natively via Bash/POSIX terminal.
• Windows       : Supported via WSL (Windows Subsystem for Linux) or Git Bash.

--------------------------------------------------------------------------------

## Support

For technical assistance, updates, or license questions, please contact support
or visit our official GitHub repository.
